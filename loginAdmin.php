...
<body>
    ...
    <div class="content">
         <form action="validationAdmin.php" method="post">
            <input type="text" name="uname" id="name" placeholder="UserId" required><br/><br/><br/>
            <input type="password" name="pass" id="name" placeholder="password"   required><br/><br/><br/>
            <input type="submit" value="login" id="sub"><br/><br/>
         </form>
       <br/><a href="signupAdmin.php" style="font-size:25px;color:white;">Register Details</a><br/><br/>
    </div>
